...
public class MapKTU<K, V> implements MapADTp<K, V> {
    ...
    {
        int elementKiek = getChainsCounter();
        int grandKiek = ChainNumber() + getChainsCounter();
        
        double average = (double) grandKiek / (double) elementKiek;
    ...
    public boolean replace(K key, V value, V newValue)
    {
        for (Node<K, V> a : table)
        {
            while (a != null)
            {                
                if (a.key.equals(key) && a.value.equals(value))
                {
                    put(key, newValue);
                    return true;
                }
    ...
    public V putIfAbsent(K key, V value)
    {
        for (Node<K, V> a : table)
        {
            while (a != null)
            {                
                if (a.key.equals(key) && a.value != null)
                {
                    return a.value;
                }
                break;
